...
public class ExtendedFileReader : BinaryReader
{
    ...
    public ExtendedFileReader(Stream input) : base(input)
    {
    }

    public ExtendedFileReader(Stream input, Encoding encoding) : base(input, encoding)
    {
    }

    public ExtendedFileReader(Stream input, Encoding encoding, bool leaveOpen) : base(input, encoding, leaveOpen)
    {
    }

    public ExtendedFileReader(Stream input, Endianness endianness) : base(input)
    {
        _endianness = endianness;
    }

    public ExtendedFileReader(Stream input, Encoding encoding, Endianness endianness) : base(input, encoding)
    {
        _endianness = endianness;
    }

    public ExtendedFileReader(Stream input, Encoding encoding, bool leaveOpen, Endianness endianness) : base(input, encoding, leaveOpen)
    {
        _endianness = endianness;
    }
